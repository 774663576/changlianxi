...
public class UserInfoActivity1 extends BaseActivity implements OnClickListener,
        OnScrollListener, ImageLoadingListener, OnTouchListener {
    ...
    class KicOutTask extends AsyncTask<CircleMember, Integer, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            BroadCast.sendBroadCast(UserInfoActivity1.this,
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = DialogUtil.getWaitDialog(UserInfoActivity1.this, "请稍候");
            dialog.show();
        }
    }
        ...
        Dialog dialog = DialogUtil.promptDialog(this, str, "确定",
                new ConfirmDialog() {
                    ...
                    public void onOKClick() {
                        finish();
                        Utils.rightOut(UserInfoActivity1.this);
                    }
        ...
        switch (v.getId()) {
            ...
            case R.id.btnSave:
                ...
                Dialog dialog = DialogUtil.confirmDialog(
                        UserInfoActivity1.this, "请选择保存方式", "保存至已有联系人", "新建联系人",
                        new ConfirmDialog() {
                            @Override
                            public void onOKClick() {
    ...
    public void onScrollStateChanged(AbsListView view, int scrollState) {
        switch (scrollState) {
            ...
            case OnScrollListener.SCROLL_STATE_IDLE:
                isfirstVisibleItem = view.getFirstVisiblePosition() == 0;
                break;
        }
    }
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        // isfirstVisibleItem = firstVisibleItem == 0;
