...
public enum PersonDetailType {
    ...
    UNKNOWN, D_NAME, D_GENDAR, D_LUNAR_BIRTHDAY, D_BIRTHDAY, D_AVATAR, D_EMPLOYER, D_JOBTITLE, D_NICKNAME, D_REMARK, D_ROLE, D_CELLPHONE, D_WORK_PHONE, D_HOME_PHONE, D_MOBILE, D_PRIVATE_PHONE, D_WORK_FAX, D_HOME_FAX, D_PAGER, D_SHORT_PHONE, D_OTHER_PHONE, D_ACCOUNT_EMAIL, D_EMAIL, D_PERSONAL_EMAIL, D_WORK_EMAIL, D_OTHER_EMAIL, D_CURRENT_ADDRESS, D_POST_ADDRESS, D_WORK_ADDRESS, D_HOME_ADDRESS, D_BIRTH_PLACE, D_QQ, D_WEIXIN, D_SINA_WEIBO, D_RENREN, D_QQ_WEIBO, D_TWITTER, D_FACEBOOK, D_SKYPE, D_BLOG, D_HOME_PAGE, D_COLLEGE, D_SENIOR_SCHOOL, D_JUNIOR_COLLEGE, D_TECHNICAL_SCHOOL, D_JUNIOR_SCHOOL, D_GRADE_SCHOOL, D_MASTER_COLLEGE, D_PHD_COLLEGE, D_KINDER_GARTEN, D_OTHER_EDU, D_JOB;
    ...
    static {
        ...
        t2text.put(D_LUNAR_BIRTHDAY, "农历生日");
        ...
        t2text.put(D_POST_ADDRESS, "通讯地址");
