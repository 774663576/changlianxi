...
import com.changlianxi.data.GrowthCommentForMeList;
import com.changlianxi.data.request.Result;
import com.changlianxi.util.DateUtils;

public class GrowthCommentForMeListParser implements IParser {
    ...
    public Result parse(Map<String, Object> params, JSONObject jsonObj)
        ...
        GrowthCommentForMeList gml = new GrowthCommentForMeList(cid);
