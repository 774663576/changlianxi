package com.changlianxi.slidingmenu.lib;
...
import com.changlianxi.slidingmenu.lib.SlidingMenu.OnClosedListener;
import com.changlianxi.slidingmenu.lib.SlidingMenu.OnOpenedListener;
...
public class CustomViewAbove extends ViewGroup {
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        if (DEBUG) if (action == MotionEvent.ACTION_DOWN) Log.v(TAG,
                "Received ACTION_DOWN");
