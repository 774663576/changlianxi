...
import com.changlianxi.view.ScrollOverListViewGrowth.OnScrollOverListener;
...
public class PullDownViewGrowth extends LinearLayout implements
    ...
    /** 已经含有 下拉刷新功能的列表 **/
    private ScrollOverListViewGrowth mListView;
    /** 刷新和更多的事件接口 **/
    ...
    public PullDownViewGrowth(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeaderViewAndFooterViewAndListView(context);
    }

    public PullDownViewGrowth(Context context) {
        super(context);
        initHeaderViewAndFooterViewAndListView(context);
    }
    ...
    public void setFirstItemIndex(int firstItemIndex) {
        mListView.setFirstItemIndex(firstItemIndex);
    }
    ...
    private void initHeaderViewAndFooterViewAndListView(Context context) {
         ...
         */
        mListView = new ScrollOverListViewGrowth(context);
    ...
    public boolean onMotionUp(MotionEvent ev) {
        ...
        if (ScrollOverListViewGrowth.canRefleash) {
            ScrollOverListViewGrowth.canRefleash = false;
