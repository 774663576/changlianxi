...
public class UserInfoUtils {
    ...
    /*电子邮箱key*/
    public static final String emailStr[] = { "D_ACCOUNT_EMAIL", "D_EMAIL",
            "D_WORK_EMAIL", "D_PERSONAL_EMAIL", "D_OTHER_EMAIL" };
    /*电子邮箱中文key*/
    public static final String emailChineseStr[] = { "电子邮箱", "常用邮箱", "工作邮箱",
            "个人邮箱", "其他邮箱" };
    ...
    public static final String infoKeyChinese[] = { "姓名", "单位", "职位", "生日",
            ...
            "工作地址", "幼儿园", "小学", "初中", "高中", "大学", "中专", "大专", "硕士", "博士", "工作" };
