...
import com.changlianxi.task.UpLoadMyCardIdetailTask;
...
public class MyCardEditActivity extends BaseActivity implements
    ...
    private void init() {
        ...
        circleMember = (MyCard) getIntent()
                .getSerializableExtra("circleMumber");
        setListener();
        setAvatar();
        filldata();
    }
    ...
    private void filldata() {
        ...
        try {
            ...
            newCircleMember = (MyCard) in.readObject();
        } catch (Exception e) {
            e.printStackTrace();
        }
            ...
            switch (viewType) {
                case 1:
                    ...
                    convertView = LayoutInflater.from(MyCardEditActivity.this)
                            .inflate(R.layout.user_info_edit_item, null);
                ...
                case 2:
                    convertView = LayoutInflater.from(MyCardEditActivity.this)
                            .inflate(R.layout.user_info_edit_item_edu, null);
    ...
    class BtnSelectGendar implements OnClickListener {
        ...
        public void onClick(View v) {
            UserInfoEditSelectTypePopwindow pop = new UserInfoEditSelectTypePopwindow(
                    MyCardEditActivity.this, layParent,
                    new String[] { "男", "女" }, "性别");
    ...
    private void synchronizeConfirmDialog() {
        Dialog dialog = DialogUtil.confirmDialog(this, "修改成功\n是否同步到其他圈子?", "是",
                "否", new ConfirmDialog() {
                    ...
                    public void onOKClick() {
                        Intent intent = new Intent();
                        intent.setClass(MyCardEditActivity.this,
                        ...
                        finish();
                        Utils.leftOutRightIn(MyCardEditActivity.this);
                    }
