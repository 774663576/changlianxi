...
public class CommentsListItemActivity extends BaseActivity implements
    ...
    private void getGrowthIdtail() {
        ...
        task.setTaskCallBack(new PostCallBack<RetError>() {
            ...
            public void taskFinish(RetError result) {
                ...
                commentList.setCid(cid);
                commentList.setGid(growth.getId());
                filldata(0);
            }
        ...
        task.setTaskCallBack(new PostCallBack<RetError>() {
            ...
            public void taskFinish(RetError result) {
                ...
                if (result == RetError.NONE) {
                    ...
                    Intent intent = new Intent(Constants.DEL_GROWTH);
                    intent.putExtra("cid", cid);
                    BroadCast.sendBroadCast(CommentsListItemActivity.this,
                            intent);
                }
            }
    ...
    private void publishedComment(String str) {
        ...
        pd.show();
        final GrowthComment growthComment = new GrowthComment(cid, gid, 0,
                growth.getPublisher(), str);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater
                        .from(CommentsListItemActivity.this).inflate(
                                R.layout.praise_list_item, null);
