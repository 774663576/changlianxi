...
import com.changlianxi.task.GetAuthCodeAgainTask;
import com.changlianxi.task.VerifyAuthCodeTask;
...
public class RegisterStep2 extends RegisterStep implements OnClickListener,
    ...
    public RegisterStep2(RegisterActivity activity, View contentRootView) {
    ...
    private void getAuthCode() {
        ...
        GetAuthCodeAgainTask task = new GetAuthCodeAgainTask();
        task.isPrompt = false;
    ...
    private void verifyAuthCode() {
        showDialog("请稍候");
        VerifyAuthCodeTask task = new VerifyAuthCodeTask(editAuthCode.getText()
                .toString());
        task.isPrompt = false;
        task.setTaskCallBack(new PostCallBack<RetError>() {
