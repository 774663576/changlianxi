...
public class MyCardActivity extends BaseActivity implements OnClickListener,
    ...
    class Adapter extends BaseExpandableListAdapter {
        ...
        public View getChildView(final int groupPosition,
            ...
            switch (viewType) {
                case 1:
                    ...
                    convertView = LayoutInflater.from(MyCardActivity.this)
            ...
            switch (viewType) {
                case 1:
                    ...
                    if (groupPosition % 2 == 0) {
                        ...
                        cHolder.bg.setBackgroundColor(MyCardActivity.this
                ...
                case 2:
                    ...
                    if (groupPosition % 2 == 0) {
                        ...
                        ediHolder.bg.setBackgroundColor(MyCardActivity.this
                                .getResources().getColor(R.color.f6));
                    }
                    break;
                case 4:
                    ...
                    if (groupPosition % 2 == 0) {
                        ...
                        holderBasic.bg.setBackgroundColor(MyCardActivity.this
                                .getResources().getColor(R.color.f6));
                    }
                    if (childPosition == 0) {
        ...
        public View getGroupView(final int groupPosition, boolean isExpanded,
            ...
            if (convertView == null) {
                ...
                convertView = LayoutInflater.from(MyCardActivity.this).inflate(
            ...
            if (groupPosition % 2 == 0) {
                ...
                gHolder.bg.setBackgroundColor(MyCardActivity.this
                        .getResources().getColor(R.color.f6));
            }
    ...
    private void initentEditActivity() {
        ...
        it.setClass(this, MyCardEditActivity.class);
    ...
    public void onScroll(AbsListView view, int firstVisibleItem,
        ...
        if (0 <= alp && alp <= 255) {
            ...
            txtShow.layout(txtShow.getLeft(), topsi - Utils.dip2px(this, 70),
                    txtShow.getRight(), botsi - Utils.dip2px(this, 70));
        }
    }
