...
import com.changlianxi.task.GetUserIdetailTask;
...
/**
 * 设置完个人信息后进入该界面查看设置后的结果
 * @author teeker_bin
 *
 */
@TargetApi(16)
public class SetPublicInfoShowInfoActivity extends BaseActivity implements
        OnClickListener, OnScrollListener, ImageLoadingListener {
    ...
    private GetUserIdetailTask task;
    ...
    private void initFooterView() {
        ...
        View footView = infla.inflate(R.layout.activity_user_info_add, null);
            ...
            switch (viewType) {
                case 1:
                    ...
                    convertView = LayoutInflater.from(
                            SetPublicInfoShowInfoActivity.this).inflate(
                ...
                case 2:
                    convertView = LayoutInflater.from(
                            SetPublicInfoShowInfoActivity.this).inflate(
                            R.layout.user_info_child_item_call_sms, null);
                ...
                case 4:
                    ...
                    if (childPosition == 0) {
                        ...
                        holderBasic.bg.setPadding(
                                ...
                                holderBasic.bg.getPaddingTop() + 15,
                    ...
                    if (childPosition == showBasicList.size() - 1) {
                        ...
                        holderBasic.bg.setPadding(
                                ...
                                holderBasic.bg.getPaddingRight(),
                                holderBasic.bg.getPaddingBottom() + 15);
                    }
                    break;
                default:
                    break;
    ...
    class KicOutTask extends AsyncTask<CircleMember, Integer, Integer> {
        ...
        protected void onPostExecute(Integer result) {
            ...
            BroadCast.sendBroadCast(SetPublicInfoShowInfoActivity.this,
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = DialogUtil.getWaitDialog(
                    SetPublicInfoShowInfoActivity.this, "请稍候");
            dialog.show();
        }
    }
        ...
        Dialog dialog = DialogUtil.promptDialog(this, str, "确定",
                new ConfirmDialog() {
                    ...
                    public void onOKClick() {
                        finish();
                        Utils.rightOut(SetPublicInfoShowInfoActivity.this);
                    }
        ...
        switch (v.getId()) {
            ...
            case R.id.btnSave:
                Dialog dialog = DialogUtil.confirmDialog(
                        SetPublicInfoShowInfoActivity.this, "请选择保存方式",
                        "保存至已有联系人", "新建联系人", new ConfirmDialog() {
                            @Override
                            public void onOKClick() {
