 ...
 *******************************************************************************/
package com.changlianxi.chooseImage;
...
public class RotateImageViewAware implements ImageAware {
    ...
    public int getWidth() {
        ...
        if (imageView != null) {
            ...
            if (width <= 0 && params != null) width = params.width; // Get
                                                                    // layout
                                                                    // width
                                                                    // parameter
    ...
    public int getHeight() {
        ...
        if (imageView != null) {
            ...
            if (height <= 0 && params != null) height = params.height; // Get
                                                                       // layout
                                                                       // height
                                                                       // parameter
    ...
    public boolean setImageBitmap(Bitmap bitmap) {
        ImageView imageView = imageViewRef.get();
        if (imageView != null) {
            imageView.setImageBitmap(BitmapUtils.reviewPicRotate(bitmap, path));
        }
        return false;
    }
}
