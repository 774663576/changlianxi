...
public class AvatarImagePagerActivity extends FragmentActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        defaultImg = getIntent().getIntExtra("defaultImg", 0);
    ...
    private class ImagePagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            return AvatarImageDetailFragment.newInstance(url, defaultImg);
        }
    }
